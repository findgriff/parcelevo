...
var memoryAvailability = new Map();
var DriversService = /** @class */ (function () {
    ...
    DriversService.prototype.setAvailability = function (driverId, state) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.redis) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.redis.set("availability:".concat(driverId), state)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                    case 2:
